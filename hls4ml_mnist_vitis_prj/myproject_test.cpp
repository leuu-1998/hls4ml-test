...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(in, conv2d_1_input);
      result_t layer12_out[N_LAYER_11];

            // hls-fpga-machine-learning insert top-level-function
            myproject(conv2d_1_input,layer12_out);
    ...
    input_t conv2d_1_input[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
    nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(conv2d_1_input);
    result_t layer12_out[N_LAYER_11];
